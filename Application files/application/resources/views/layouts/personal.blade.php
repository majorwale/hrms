...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('/assets/vendor/flag-icon-css/css/flag-icons.min.css') }}">
    ...
    <div class="wrapper">
        ...
        <nav id="sidebar" class="active">
            <div class="sidebar-header text-center">
                <a class="navbar-brand" href="{{ url('/personal/dashboard') }}">
                            ...
                            <div class="nav-dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end nav-link-menu" aria-labelledby="nav1">
                                    <ul class="nav-list">
                                        ...
                                        <li><a href="{{ url('lang/es') }}" class="dropdown-item"><i class="fi fi-es mr-2"></i> Español</a></li>
                                        <li><a href="{{ url('lang/fr') }}" class="dropdown-item"><i class="fi fi-fr mr-2"></i> Français</a></li>
                                        <li><a href="{{ url('lang/de') }}" class="dropdown-item"><i class="fi fi-de mr-2"></i> Deutsch</a></li>
                                        <li><a href="{{ url('lang/it') }}" class="dropdown-item"><i class="fi fi-it mr-2"></i> Italian</a></li>
                                        <li><a href="{{ url('lang/ru') }}" class="dropdown-item"><i class="fi fi-ru mr-2"></i> Russian</a></li>
                                        <li><a href="{{ url('lang/pt') }}" class="dropdown-item"><i class="fi fi-pt mr-2"></i> Português</a></li>
                                        <li><a href="{{ url('lang/nl') }}" class="dropdown-item"><i class="fi fi-nl mr-2"></i> Dutch</a></li>
                                        <li><a href="{{ url('lang/in') }}" class="dropdown-item"><i class="fi fi-in mr-2"></i> Hindi</a></li>
                                        <li><a href="{{ url('lang/jp') }}" class="dropdown-item"><i class="fi fi-jp mr-2"></i> 日本語</a></li>
                                        <li><a href="{{ url('lang/my') }}" class="dropdown-item"><i class="fi fi-my mr-2"></i> Malay</a></li>
                                        <li><a href="{{ url('lang/ph') }}" class="dropdown-item"><i class="fi fi-ph mr-2"></i> Filipino</a></li>
                                        <li><a href="{{ url('lang/tr') }}" class="dropdown-item"><i class="fi fi-tr mr-2"></i> Turkish</a></li>
                                    </ul>
                                </div>
                            </div>
                        </li>
